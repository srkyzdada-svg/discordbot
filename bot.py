...
async def on_ready():
    ...
    print(f'⭐ 3/5: {RATINGS.count("3/5")} reviews')
    print(f'⭐ 4/5: {RATINGS.count("4/5")} reviews')
    print(f'⭐ 5/5: {RATINGS.count("5/5")} reviews')
    print(f'📦 {len(ORDER_TYPES)} products available with prices from the images')
